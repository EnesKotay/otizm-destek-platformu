...
function buildRecommendedGames(focusAreas: FocusArea[]): TherapyGame[] {
  const gameLibrary: Record<FocusKey, TherapyGame[]> = {
    communication: [
      ...
      { id: 'sound-echo-fun',           key: 'communication', title: 'Ses Yakalama & Eko', skill: 'Ses taklidi ve konuşma teşviki',approach: 'Ses taklidi',     benefit: 'Hayvan sesleri, motor sesleri ve basit heceleri neşeyle taklit etmeyi öğretir.',duration: '4 dk', instruction: 'Resimli karttaki hayvanın sesini ("Möö", "Haf") çıkarın, çocuğun aynı sesi çıkarmasını bekleyin.',                                                   tip: 'Sesleri abartılı ve eğlenceli jestlerle çıkarmak taklit etme isteğini artırır.',            tone: 'sky',   icon: <MessageSquareText size={20} aria-hidden="true" />, linkedGoal: 'İletişim hedefleri', linkedTool: 'PECS Kart Kütüphanesi' },
      { id: 'bubble-word-play',         key: 'communication', title: 'Baloncuk ve Kelime Nefesi', skill: 'Nefes ve ilk kelimeler', approach: 'Oyun içi kelime', benefit: 'Köpük baloncuklarla "Pat!", "Aç!", "Uçtu!" gibi ilk kelimeleri pekiştirir.', duration: '5 dk', instruction: 'Köpük baloncuk üfleyin. Şişeyi kapatın. Çocuk "Aç" veya "Pat" diyene ya da işaret edene kadar bekleyip sonra üfleyin.', tip: 'Çocuğa kelimeyi zorlamayın; neşeli jestle beklemek iletişimi kendiliğinden başlatır.', tone: 'sky',   icon: <MessageSquareText size={20} aria-hidden="true" />, linkedGoal: 'İletişim hedefleri', linkedTool: 'PECS Kart Kütüphanesi' },
      { id: 'mystery-box-naming',       key: 'communication', title: 'Sihirli Torba Nerede?', skill: 'Kelime dağarcığı ve ifade', approach: 'Görsel keşif',    benefit: 'Torbadan çıkan nesnenin adını söyleme veya kartla eşleştirme becerisini geliştirir.', duration: '6 dk', instruction: 'Kumaş torbaya 4 tanıdık nesne koyun. Çocuğun elini sokup nesneyi tahmin etmesini veya çıkarıp adını söylemesini isteyin.', tip: 'Doğru söylediğinde veya işaret ettiğinde nesne ile kısa bir oyun oynayın.',               tone: 'sky',   icon: <MessageSquareText size={20} aria-hidden="true" />, linkedGoal: 'İletişim hedefleri', linkedTool: 'AAC Dijital Tahta' },
    ],
    social: [
      ...
      { id: 'peekaboo-gaze', key: 'social', title: 'Cee-A ve Doğal Göz Teması', skill: 'Doğal göz teması', approach: 'Sosyal neşe',                 benefit: 'Baskı oluşturmadan neşeli oyun içinde doğrudan göz teması kurmayı sağlar.',                       duration: '4 dk', instruction: 'Tül veya şapka arkasına saklanın. "Cee!" derken çocuğun gözlerine bakın ve gülümseyin.',                             tip: 'Göz temasını zorlamayın; oyun neşesi arttıkça çocuk kendiliğinden gözlerinize bakacaktır.', tone: 'emerald', icon: <Activity size={20} aria-hidden="true" />, linkedGoal: 'Sosyal Beceriler', linkedTool: 'Sosyal Hikâye Kartları' },
      { id: 'high-five-rhythm', key: 'social', title: 'Çak ve Ritim Tut', skill: 'Sosyal etkileşim ve ritim', approach: 'Ritmik paylaşım',         benefit: 'Tempo ve ortak hareketle sosyal bağ kurmayı güçlendirir.',                                         duration: '5 dk', instruction: 'Müzik eşliğinde el el el çırpma ve "Çak!" yapma ritmi oluşturun.',                                                   tip: 'Çocuğun temposuna uymaya özen gösterin.',                                                  tone: 'emerald', icon: <Activity size={20} aria-hidden="true" />, linkedGoal: 'Sosyal Beceriler', linkedTool: 'AAC Dijital Tahta' },
      { id: 'mini-tea-party', key: 'social', title: 'Mini Evcilik & İkram', skill: 'Sembolik oyun',       approach: 'Rol oyunu',                    benefit: 'Oyuncak bebek veya ayıya çay/yemek ikram ederek sembolik oyun becerisini başlatır.',              duration: '6 dk', instruction: 'Fincana hayali çay doldurun, ayıya içirin ve ardından bardağı çocuğa verip içirmesini isteyin.',                       tip: 'Hayali oyunlar otizmde soyut düşünme ve sembolik zekayı çok güçlü besler.',              tone: 'emerald', icon: <Activity size={20} aria-hidden="true" />, linkedGoal: 'Sosyal Beceriler', linkedTool: 'Sosyal Hikâye Kartları' },
    ],
    sensory: [
      ...
      { id: 'pillow-sandwich',    key: 'sensory', title: 'Yumuşak Yastık Sandviçi', skill: 'Proprioseptif derin basınç', approach: 'Derin basınç', benefit: 'Minderler arasında hafif derin basınç uygulayarak sinir sistemini sakinleştirir.', duration: '5 dk', instruction: 'Çocuğu iki yumuşak yastık arasına yatırın. "Sandviç yapıyoruz!" diyerek kollarına ve sırtına hafifçe bastırın.',                    tip: 'Basınç miktarını çocuğun tepkisine göre ayarlayın, asla zorlamayın.',                     tone: 'amber', icon: <Sparkles size={20} aria-hidden="true" />, linkedGoal: 'Duyusal düzenleme', linkedTool: 'Duyusal Destek Kutusu' },
      { id: 'texture-rice-box',   key: 'sensory', title: 'Pirinç Havuzu & Gizli Hazine', skill: 'Dokunsal hassasiyet', approach: 'Duyusal arama', benefit: 'Pirinç veya mercimek dolu sepette oyuncak arayarak dokunsal töleransı artırır.', duration: '6 dk', instruction: 'Derin bir kaba pirinç doldurun ve içine küçük oyuncaklar saklayın. Çocuğun elleriyle oyuncakları bulmasını isteyin.',            tip: 'Dokunmaktan çekinirse önce bir kaşık vererek aramasını sağlayabilirsiniz.',                tone: 'amber', icon: <Sparkles size={20} aria-hidden="true" />, linkedGoal: 'Duyusal düzenleme', linkedTool: 'Duyusal Destek Kutusu' },
      { id: 'calm-feather-breath', key: 'sensory', title: 'Tüy Uçurma Nefesi', skill: 'Nefes kontrolü ve sakinleşme', approach: 'Görsel nefes', benefit: 'Tüy veya kağıt mendil uçurarak yavaş nefes alıp vermeyi eğlenceli hale getirir.', duration: '4 dk', instruction: 'Masaya bir tüy koyun. Derin nefes alıp tüyü yavaşça üfleyerek karşı tarafa geçirmeye çalışın.',                                      tip: 'Kaygılı anlarda nefes kontrolünü öğrenmek öz-düzenlemeyi kolaylaştırır.',                   tone: 'amber', icon: <Sparkles size={20} aria-hidden="true" />, linkedGoal: 'Duyusal düzenleme', linkedTool: 'Duyusal Destek Kutusu' },
    ],
    motor: [
      ...
      { id: 'animal-walks-fun', key: 'motor', title: 'Hayvan Yürüyüşleri (Yengeç & Ayı)', skill: 'Kaba motor ve güç', approach: 'Eğlenceli hareket', benefit: 'Kolları, bacakları ve gövde kaslarını oyunla güçlendirir.', duration: '5 dk', instruction: 'Odayı "orman" ilan edin. Sırayla kurbağa gibi zıplayın, yengeç gibi yan yürüyün veya ayı gibi emekleyin.',                               tip: 'Çocuğun hangi hayvan olmak istediğini seçmesine izin verin.',                             tone: 'emerald', icon: <Dumbbell size={20} aria-hidden="true" />, linkedGoal: 'Motor Beceriler', linkedTool: 'Motor Aktivite Seti' },
      { id: 'dough-treasure-hunt', key: 'motor', title: 'Oyun Hamurunda Hazine', skill: 'İnce motor kavrama', approach: 'Parmak güçlendirme', benefit: 'Yumuşak hamur yoğurma ve içinden boncuk çıkarma ile parmak kaslarını çalıştırır.', duration: '6 dk', instruction: 'Oyun hamurunun içine küçük düğmeler veya boncuklar gömün. Çocuktan parmaklarıyla cımbız gibi çekip çıkarmasını isteyin.',            tip: 'Başparmak ve işaret parmağını (cımbız tutuşu) kullanmasını teşvik edin.',                 tone: 'emerald', icon: <Dumbbell size={20} aria-hidden="true" />, linkedGoal: 'Motor Beceriler', linkedTool: 'Motor Aktivite Seti' },
      { id: 'clothespin-clip', key: 'motor', title: 'Mandal Takma & Çıkarma', skill: 'El becerisi ve kıskaç tutuşu', approach: 'Kıskaç kavrama', benefit: 'Kalem tutma ve makas kullanma öncesi el kas kontrolünü artırır.', duration: '5 dk', instruction: 'Karton bir kutunun kenarlarına renklere göre mandal takmasını ve ardından tek tek sökmesini isteyin.',                                          tip: 'Büyük ve kolay basılan mandallarla başlayın.',                                             tone: 'emerald', icon: <Dumbbell size={20} aria-hidden="true" />, linkedGoal: 'Motor Beceriler', linkedTool: 'Motor Aktivite Seti' },
    ],
    behavior: [
      ...
      { id: 'stop-and-go-game', key: 'behavior', title: 'Kırmızı Işık - Yeşil Işık', skill: 'Dürtü kontrolü', approach: 'Kural takibi', benefit: 'Kendi hareketlerini durdurma ve başlatma (öz-kontrol) yeteneğini kazandırır.', duration: '5 dk', instruction: 'Siz "Yeşil!" deyince çocuk yürür, "Kırmızı!" deyince heykel gibi durur. Kurallara uyunca alkışlayın.',                               tip: 'Kırmızı dediğinizde sizin de heykel gibi durmanız kuralı görselleştirir.',                  tone: 'amber', icon: <Brain size={20} aria-hidden="true" />, linkedGoal: 'Davranış Desteği', linkedTool: 'Token Ekonomisi Panosu' },
      { id: 'first-then-visual', key: 'behavior', title: 'Önce Yap - Sonra Kazan', skill: 'Görev erteleme yönetimi', approach: 'Görsel kural', benefit: 'Zor gelen bir görevin ardından sevilen aktivitenin geleceğini netleştirir.', duration: '5 dk', instruction: '"Önce oyuncakları topluyoruz, sonra park gezisi!" görsel kartını gösterin ve adımları takip edin.',                                          tip: 'İki adım arasında uzun bekleme olmamasına dikkat edin.',                                   tone: 'amber', icon: <Brain size={20} aria-hidden="true" />, linkedGoal: 'Davranış Desteği', linkedTool: 'Token Ekonomisi Panosu' },
      { id: 'emotion-thermometer-game', key: 'behavior', title: 'Duygu Termometresi', skill: 'Öfke farkındalığı', approach: 'Görsel derece', benefit: 'Çocuğun kızgınlık derecesini görsel derece üzerinde fark edip düşürmesini sağlar.', duration: '5 dk', instruction: 'Derece kartında Kırmızı (çok kızgın) alanına gelince "Buz olalım ve eriyelim" oyunu oynayın.',                                          tip: 'Erimem oyunu yaparken vücuttaki kasları gevşetmeyi gösterin.',                             tone: 'amber', icon: <Brain size={20} aria-hidden="true" />, linkedGoal: 'Davranış Desteği', linkedTool: 'Token Ekonomisi Panosu' },
    ],
    education: [
      ...
      { id: 'shadow-match',   key: 'education', title: 'Gölge Eşleştirme', skill: 'Görsel algı ve dikkat', approach: 'Görsel ayırt etme', benefit: 'Nesnelerin siyah gölgelerini bularak görsel dikkati ve soyutlama becerisini geliştirir.', duration: '5 dk', instruction: 'Hayvan ve nesnelerin siyah gölge kartlarını dizin. Gerçek nesneleri doğru gölgenin üzerine koymasını isteyin.',                    tip: 'İlk seferde sadece 3 belirgin gölge ile başlayın.',                                        tone: 'sky', icon: <BookOpen size={20} aria-hidden="true" />, linkedGoal: 'Eğitim Becerileri', linkedTool: 'Öğrenme Aktivite Kutusu' },
      { id: 'pattern-repeat', key: 'education', title: 'Desen Mantığı (Kırmızı-Mavi)', skill: 'Sıralama ve mantık', approach: 'Desen sıralama', benefit: 'Sıralama ve öngörü yeteneğini geliştirerek matematiksel düşünmeyi destekler.', duration: '6 dk', instruction: 'Kırmızı-Mavi-Kırmızı-Mavi düğmeleri dizin. Sıradaki rengin ne olacağını sorun ve koymasını isteyin.',                                         tip: 'Sesli olarak "Kırmızı, Mavi, Kırmızı..." diye ritim tutmak kavramayı kolaylaştırır.', tone: 'sky', icon: <BookOpen size={20} aria-hidden="true" />, linkedGoal: 'Eğitim Becerileri', linkedTool: 'Öğrenme Aktivite Kutusu' },
      { id: 'category-sort',  key: 'education', title: 'Meyve mi Hayvan mı?', skill: 'Kavramsal sınıflandırma', approach: 'Kategori ayırma', benefit: 'Nesneleri özelliklerine göre gruplandırarak hafıza ve dil zekasını güçlendirir.', duration: '5 dk', instruction: 'İki ayrı kutu koyun (Biri Meyveler, Biri Hayvanlar). Resimli kartları doğru kutuya atmasını isteyin.',                                     tip: 'Doğru kutuya attığında nesnenin ismini neşeyle tekrarlayın.',                              tone: 'sky', icon: <BookOpen size={20} aria-hidden="true" />, linkedGoal: 'Eğitim Becerileri', linkedTool: 'Öğrenme Aktivite Kutusu' },
    ],
  };
