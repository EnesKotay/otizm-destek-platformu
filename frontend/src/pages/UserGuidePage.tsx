...
const PARENT_GUIDE: GuideGroup[] = [
  {
    title: 'Başlangıç ve günlük kullanım',
    description: 'Yeni kullanıcı için en sık bakılacak temel sayfalar.',
    pages: [
      {
      ...
      },
      {
        ...
        badge: 'İlk adım',
        keywords: ['çocuk', 'profil', 'tanı', 'terapi', 'bilgi'],
      },
      {
        icon: ClipboardList,
        title: 'Bugünün Kaydı',
        ...
        badge: 'Kısa kayıt',
        keywords: ['günlük', 'ruh hali', 'uyku', 'ilaç', 'kayıt'],
      },
      {
        icon: AlertTriangle,
        title: 'Zor An Rehberi',
        to: '/kriz-rehberi',
        ...
        badge: 'Hızlı destek',
        keywords: ['kriz', 'zor an', 'sakinleşme', 'acil', 'destek'],
      },
    ],
  },
  {
    title: 'Takip ve gelişim',
    description: 'Kayıtları anlamlandırmak, ilerlemeyi görmek ve günlük not tutmak için.',
    pages: [
      {
        icon: TrendingUp,
        ...
        keywords: ['ilerleme', 'grafik', 'analiz', 'trend', 'gelişim'],
      },
      {
        icon: NotebookTabs,
        title: 'Gözlem Notları',
        to: '/notlar',
        ...
        keywords: ['not', 'gözlem', 'gelişim', 'davranış', 'hatırlatma'],
      },
      {
        icon: BookOpen,
        title: 'Davranış Notu',
        ...
        keywords: ['davranış', 'abc', 'öncesi', 'sonrası', 'örüntü'],
      },
      {
        icon: Activity,
        title: 'Günlük Plan',
        ...
        keywords: ['tedavi', 'plan', 'hedef', 'aktivite', 'ev çalışması'],
      },
    ],
  },
  {
    title: 'Randevu, uzman ve paylaşım',
    description: 'Uzman desteği almak ve hangi bilginin paylaşılacağını yönetmek için.',
    pages: [
      {
        icon: GraduationCap,
        title: 'Uzmanlar',
        to: '/uzmanlar',
        purpose: 'Uzman profillerini inceleme ve destek seçeneklerini görme alanıdır.',
        useWhen: 'Bir uzmandan destek almak veya kimlerin olduğunu görmek istediğinde.',
        keywords: ['uzman', 'terapist', 'doktor', 'destek', 'profil'],
      },
      {
        icon: CalendarCheck,
        title: 'Randevu ve Uzman',
        to: '/randevular',
        ...
        keywords: ['randevu', 'takvim', 'seans', 'görüşme', 'uzman'],
      },
      {
        icon: ShieldCheck,
        ...
        keywords: ['paylaşım', 'uzman', 'izin', 'gizlilik', 'ilerleme'],
      },
      {
        icon: MessageCircle,
        title: 'Mesajlar',
  ...
  {
    title: 'Planlama ve günlük yaşam',
    description: 'Rutin, okul, beslenme ve güvenlik gibi pratik alanlar.',
    pages: [
      {
        icon: Calendar,
        title: 'Takvim',
      ...
      },
      {
        ...
        keywords: ['rutin', 'program', 'adım', 'görsel', 'geçiş'],
      },
      {
        icon: ClipboardCheck,
        title: 'Ev Ödevleri',
        ...
        keywords: ['görev', 'ödev', 'uzman', 'tamamlandı', 'takip'],
      },
      {
        icon: ShieldAlert,
        ...
        keywords: ['acil', 'kart', 'güvenlik', 'bilgi', 'qr'],
      },
    ],
  },
  {
    title: 'Topluluk ve kaynaklar',
    description: 'Bilgi almak, paylaşmak ve yalnız hissetmemek için.',
    pages: [
      {
        icon: Users,
        title: 'Gruplar',
        to: '/gruplar',
        purpose: 'Benzer konulardaki aile ve uzman topluluklarını bir araya getirir.',
        useWhen: 'Belirli bir konuda topluluk desteği aradığında.',
        keywords: ['grup', 'topluluk', 'aile', 'paylaşım', 'destek'],
      },
      {
        icon: Heart,
        ...
        useWhen: 'Soru sormaktan çok içini dökmek veya destek görmek istediğinde.',
        keywords: ['dertleşme', 'duygu', 'paylaşım', 'destek', 'aile'],
      },
      {
        icon: BookOpen,
        title: 'Bilgi Bankası',
        ...
        keywords: ['bilgi', 'makale', 'rehber', 'kaynak', 'öğrenme'],
      },
      {
        icon: Smile,
        ...
        keywords: ['ebeveyn', 'refah', 'stres', 'iyi oluş', 'öz bakım'],
      },
    ],
  },
];
...
const EXPERT_GUIDE: GuideGroup[] = [
  {
    title: 'Günlük uzman akışı',
    description: 'Randevu, danışan ve iletişim akışının ana bölümleri.',
    pages: [
      {
        icon: LayoutDashboard,
        title: 'Ana Sayfa',
      ...
      },
      {
        ...
        keywords: ['randevu', 'müsaitlik', 'takvim', 'onay', 'program'],
      },
      {
        icon: MessageCircle,
        title: 'Mesajlar',
  ...
  {
    title: 'Klinik takip ve karar',
    description: 'Doktorun muayene, risk, rapor ve terapi planını hızlı yönetmesi için.',
    pages: [
      {
        icon: ClipboardList,
        title: 'Klinik Takip',
      ...
      },
      {
        ...
        useWhen: 'Aileye, okula veya kuruma verilecek düzenli bir çıktı gerektiğinde.',
        badge: 'Belge',
        keywords: ['rapor', 'bep', 'gelişim raporu', 'çıktı', 'belge'],
      },
      {
        icon: ShieldAlert,
      ...
      {
        icon: LayoutDashboard,
        title: '30 Saniyelik Başlangıç',
        to: '/anasayfa',
        purpose: 'Bugünkü randevu, mesaj ve bekleyen işleri tek bakışta görmeni sağlar.',
        useWhen: 'Yoğun poliklinik gününde hızlıca sıradaki aksiyonu seçmek istediğinde.',
        keywords: ['hızlı kullanım', 'dashboard', 'özet', 'randevu', 'mesaj'],
      },
    ],
  },
  {
    title: 'Uzman araçları ve kaynaklar',
    description: 'Raporlama, kaynak ve topluluk sayfaları.',
    pages: [
      {
        icon: FileText,
        title: 'BEP Raporu',
        to: '/bep-raporu',
        purpose: 'Bireyselleştirilmiş Eğitim Planı raporlarını hazırlama alanıdır.',
        useWhen: 'Danışan için yapılandırılmış rapor üretmek istediğinde.',
        keywords: ['bep', 'rapor', 'eğitim', 'plan', 'belge'],
      },
      {
        icon: BookOpen,
        title: 'Bilgi Bankası',
...
const ADMIN_GUIDE: GuideGroup[] = [
  {
    ...
    description: 'Platformu izlemek ve temel yönetim işlerini yapmak için.',
    pages: [
      {
        icon: LayoutDashboard,
        title: 'Ana Sayfa',
  ...
  },
  {
    ...
    description: 'Yayınlanan içerikler, raporlar ve sistem ayarları.',
    pages: [
      {
        icon: BookOpen,
