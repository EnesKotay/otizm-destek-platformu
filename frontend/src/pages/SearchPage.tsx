...
import { Search, BookOpen, FileText, Users, GraduationCap, Clock, SlidersHorizontal, X, ChevronDown, Tag } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-400">Yukarıdaki arama kutusunu kullanarak arama yapın</p>
          <p className="text-sm text-gray-300 mt-1">Gönderi, makale, grup ve uzman arayabilirsiniz</p>
        </div>
      ) : null}
    </div>
  );
