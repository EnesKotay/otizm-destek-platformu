  ...
  PARENT: [
    {
      ...
      items: [
        ...
        { to: '/kriz-rehberi', icon: AlertTriangle, label: 'Zor An Rehberi', description: 'Sakinleşme için kısa adımlar', keywords: ['kriz', 'sakinleşme', 'destek'], badgeKey: 'crisis', simple: true },
        { to: '/yardim', icon: HelpCircle, label: 'Yardım', description: 'Takıldığınızda ilk bakılacak yer', keywords: ['yardım', 'sss', 'destek', 'rehber'], simple: true },
        { to: '/takvim', icon: Calendar, label: 'Takvim', description: 'Seans, görev ve hatırlatmalar', keywords: ['plan', 'etkinlik', 'hatırlatma'], requiresChild: true },
      ],
    },
    {
      ...
      items: [
        ...
        { to: '/tedavi', icon: Activity, label: 'Günlük Plan', description: 'Küçük hedefler ve ev çalışmaları', keywords: ['terapi', 'hedef', 'klinik'], requiresChild: true },
        { to: '/paylasimli-ilerleme', icon: ShieldCheck, label: 'Uzmanla Paylaş', description: 'Hangi bilginin gideceğini yönetin', keywords: ['paylaşım', 'uzman', 'rapor'], requiresChild: true },
        { to: '/tarama', icon: ClipboardList, label: 'Kısa Değerlendirme', description: 'Bilgilendirici tarama ve aktiviteler', keywords: ['test', 'aktivite', 'değerlendirme'], requiresChild: true },
        { to: '/duyusal-profil', icon: Brain, label: 'Rahatlatan Şeyler', description: 'Hassasiyet ve tercih notları', keywords: ['duyu', 'hassasiyet', 'profil'], requiresChild: true },
        { to: '/davranis-gunlugu', icon: BookCheck, label: 'Davranış Notu', description: 'Öncesi ve sonrasıyla gözlem', keywords: ['abc', 'davranış', 'günlük'], requiresChild: true },
        { to: '/notlar', icon: FileText, label: 'Gözlem Notları', description: 'Kısa gelişim ve görüşme notları', keywords: ['not', 'gözlem', 'kayıt'], requiresChild: true },
      ],
    },
    {
      label: 'Günlük Yaşam',
